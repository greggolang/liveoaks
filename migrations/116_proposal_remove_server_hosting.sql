-- Remove server hosting line item from Section 3 of the board proposal.
-- All derived figures updated:
--   Portal total:      $450/mo ($5,400/yr) → $400/mo ($4,800/yr)
--   Monthly savings:   $150 → $200
--   Annual savings:    $1,800 → $2,400
--   3-year cumulative: $5,400 → $7,200
-- SVG charts redrawn to match the new figures.
...
<p>The LOTA Portal is a single, custom-built platform that replaces four separate services the club currently pays for — website hosting, Google Workspace, CourtReserve, and our outside billing person. Consolidating these into one system <strong>lowers monthly costs from $600 to $400</strong>, saving the club <strong>$2,400 per year</strong> — while giving members a far better experience and giving the board more visibility and control than we have ever had.</p>
<table>
  <thead><tr><th></th><th>Today</th><th>With the Portal</th><th>Change</th></tr></thead>
  <tbody>
    <tr><td>Monthly cost</td><td>$600</td><td>$400</td><td>&#8722;$200 / mo</td></tr>
    <tr><td>Annual cost</td><td>$7,200</td><td>$4,800</td><td>&#8722;$2,400 / yr</td></tr>
...
<svg viewBox="0 0 440 270" xmlns="http://www.w3.org/2000/svg" width="440" height="270">
  ...
  <rect x="260" y="95" width="100" height="120" fill="#16a34a" rx="4"/>
  <text x="310" y="89" text-anchor="middle" font-size="12" font-weight="bold" fill="#15803d" font-family="sans-serif">$400/mo</text>
  ...
  <line x1="225" y1="35" x2="225" y2="95" stroke="#2563eb" stroke-width="1.5" stroke-dasharray="3,2"/>
  <line x1="221" y1="35" x2="229" y2="35" stroke="#2563eb" stroke-width="1.5"/>
  <line x1="221" y1="95" x2="229" y2="95" stroke="#2563eb" stroke-width="1.5"/>
  <text x="220" y="262" text-anchor="middle" font-size="11" fill="#1d4ed8" font-family="sans-serif" font-weight="bold">Net savings: $200/month &#183; $2,400/year</text>
</svg>
...
<table>
  ...
  <tbody>
    ...
    <tr><td><strong>Total</strong></td><td><strong>$400 / mo ($4,800/yr)</strong></td><td></td></tr>
  </tbody>
</table>
<p><strong>Net result: $600/mo &#8722; $400/mo = $200/mo saved ($2,400/year), with more capability than all four current services combined.</strong></p>
<svg viewBox="0 0 440 220" xmlns="http://www.w3.org/2000/svg" width="440" height="220">
  ...
  <text x="62" y="29" text-anchor="end" font-size="10" fill="#6b7280" font-family="sans-serif">$7,200</text>
  <text x="62" y="82" text-anchor="end" font-size="10" fill="#6b7280" font-family="sans-serif">$4,800</text>
  <text x="62" y="136" text-anchor="end" font-size="10" fill="#6b7280" font-family="sans-serif">$2,400</text>
  ...
  <text x="180" y="124" text-anchor="middle" font-size="10" fill="#1d4ed8" font-family="sans-serif" font-weight="bold">$2,400</text>
  <text x="290" y="70" text-anchor="middle" font-size="10" fill="#1d4ed8" font-family="sans-serif" font-weight="bold">$4,800</text>
  <text x="400" y="17" text-anchor="middle" font-size="10" fill="#1d4ed8" font-family="sans-serif" font-weight="bold">$7,200</text>
