-- Update the board-meeting proposal: portal software fee raised to $400/mo.
-- All derived figures updated:
--   Portal total: $350/mo → $450/mo ($5,400/yr)
--   Monthly savings: $250 → $150
--   Annual savings:  $3,000 → $1,800
-- SVG charts are redrawn to match the new figures.
UPDATE collab_documents
SET
  body = $body$<h1>Board Meeting Proposal — The LOTA Member Portal</h1>
...
<p>The LOTA Portal is a single, custom-built platform that replaces four separate services the club currently pays for — website hosting, Google Workspace, CourtReserve, and our outside billing person. Consolidating these into one system <strong>lowers monthly costs from $600 to $450</strong>, saving the club <strong>$1,800 per year</strong> — while giving members a far better experience and giving the board more visibility and control than we have ever had.</p>
<table>
  <thead><tr><th></th><th>Today</th><th>With the Portal</th><th>Change</th></tr></thead>
  <tbody>
    <tr><td>Monthly cost</td><td>$600</td><td>$450</td><td>&#8722;$150 / mo</td></tr>
    <tr><td>Annual cost</td><td>$7,200</td><td>$5,400</td><td>&#8722;$1,800 / yr</td></tr>
...
<svg viewBox="0 0 440 270" xmlns="http://www.w3.org/2000/svg" width="440" height="270">
  ...
  <rect x="260" y="80" width="100" height="135" fill="#16a34a" rx="4"/>
  <text x="310" y="74" text-anchor="middle" font-size="12" font-weight="bold" fill="#15803d" font-family="sans-serif">$450/mo</text>
  ...
  <line x1="225" y1="35" x2="225" y2="80" stroke="#2563eb" stroke-width="1.5" stroke-dasharray="3,2"/>
  <line x1="221" y1="35" x2="229" y2="35" stroke="#2563eb" stroke-width="1.5"/>
  <line x1="221" y1="80" x2="229" y2="80" stroke="#2563eb" stroke-width="1.5"/>
  <text x="220" y="262" text-anchor="middle" font-size="11" fill="#1d4ed8" font-family="sans-serif" font-weight="bold">Net savings: $150/month &#183; $1,800/year</text>
</svg>
...
<table>
  ...
  <tbody>
    ...
    <tr><td>Portal software</td><td>$400 / mo ($4,800/yr)</td><td>Ongoing license, hosting management, updates, and new features. Support is included — no separate contract or hourly billing.</td></tr>
    <tr><td><strong>Total</strong></td><td><strong>$450 / mo ($5,400/yr)</strong></td><td></td></tr>
  </tbody>
</table>
<p><strong>Net result: $600/mo &#8722; $450/mo = $150/mo saved ($1,800/year), with more capability than all four current services combined.</strong></p>
<svg viewBox="0 0 440 220" xmlns="http://www.w3.org/2000/svg" width="440" height="220">
  ...
  <text x="62" y="29" text-anchor="end" font-size="10" fill="#6b7280" font-family="sans-serif">$5,400</text>
  <text x="62" y="82" text-anchor="end" font-size="10" fill="#6b7280" font-family="sans-serif">$3,600</text>
  <text x="62" y="136" text-anchor="end" font-size="10" fill="#6b7280" font-family="sans-serif">$1,800</text>
  ...
  <text x="180" y="124" text-anchor="middle" font-size="10" fill="#1d4ed8" font-family="sans-serif" font-weight="bold">$1,800</text>
  <text x="290" y="70" text-anchor="middle" font-size="10" fill="#1d4ed8" font-family="sans-serif" font-weight="bold">$3,600</text>
  <text x="400" y="17" text-anchor="middle" font-size="10" fill="#1d4ed8" font-family="sans-serif" font-weight="bold">$5,400</text>
...
<p>Support is included in the $400/month — there is no separate support contract or hourly billing.</p>
<ul>
