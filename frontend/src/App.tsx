...
import AdminMessageBookings from './pages/admin/AdminMessageBookings'
...
function AppRoutes() {
  return (
    ...
    <Routes>
      ...
      <Route path="/document-editor" element={<BoardRoute><Documents /></BoardRoute>} />
      <Route path="/docs" element={<Navigate to="/document-editor" replace />} />
      ...
      <Route path="/admin" element={<ProtectedRoute><Admin /></ProtectedRoute>}>
        ...
        <Route path="message-bookings" element={<AdminMessageBookings />} />
